...
const SectionWrapper = ({ title, description, showBtn, mockupImg, banner, reverse }) => {
  return (
    ...
    ${banner}`}>
      ...
      ${reverse ? styles.boxReverseClass : styles.boxClass} w-11/12 sm:w-full minmd:w3/4`}>
        ...
        {showBtn && (
          ...
          link="https://expo.dev/@vishal2799/rn-nft-app?serviceType=classic&distribution=expo-go"
          />
        )}
        </div>
